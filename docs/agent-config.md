...
| -------------- | --------------------------------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `host`         | `HostProviderDefinition`                | `"self"`         | Host that operates this agent's runtime services, selecting the workflow world, sandbox backend, and build output. Root-only. Pass `vercel()` from `eve/hosts/vercel`; see [Self-host eve](./guides/deployment/self-hosting#choose-the-host).             |
