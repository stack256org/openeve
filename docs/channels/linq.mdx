...
**Use portable credentials**, the default during `eve add channel/linq`, works on any host. eve writes `LINQ_API_KEY` and `LINQ_WEBHOOK_SECRET` to `.env.local`.
