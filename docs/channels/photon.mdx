...
**Use portable credentials**, the default during
`eve add channel/photon-imessage`, works on any host. eve scaffolds the channel
and writes `IMESSAGE_PROJECT_ID` and `IMESSAGE_PROJECT_SECRET` to `.env.local`.
