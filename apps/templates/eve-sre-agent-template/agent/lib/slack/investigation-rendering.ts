import { type BlockKitBlock, Card, type CardElement, CardText } from "eve/channels/slack";
import { type InvestigationEvidence, renderCompactInvestigationEvidence } from "#lib/evidence.ts";
