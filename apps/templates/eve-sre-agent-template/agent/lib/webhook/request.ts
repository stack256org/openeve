...
export function verifyWebhookSecret(headers: Headers, expected: string | undefined): boolean {
...
export type WebhookJsonResult = { ok: true; raw: unknown } | { ok: false; response: Response };
