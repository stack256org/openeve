...
export function formatInvestigationPrompt(webhook: InvestigationWebhook): string {
  ...
  try {
    ...
    console.warn("Failed to parse metadata from webhook-initiated investigation", err);
    renderedMetadata = "";
  }
