...
export type ChannelWatchAdmissionDropReason = ChannelWatchDropReason | "not_watched";
...
const ALLOWED_SUBTYPES: ReadonlySet<string> = new Set(["file_share", "bot_message"]);
const LINE_SPLIT = /\r?\n/u;
...
export function evaluateChannelWatchMessage(message: ChannelWatchMessage): ChannelWatchEvaluation {
